...
import com.haz.myjoballocationapp.R
import android.synthetic.main.popup.view.*
...
class JobListAdapter(
    ...
    inner class ViewHolder(itemView: View, context: Context, list: ArrayList<job>) :
        ...
        fun editJob(job: job) {
            ...
            var JobName = view.id
            var assignedBy = view.id
            var assignedTo = view.id
            var saveButton = view.id
            ...
            saveButton.setOnclickListener {
                var name = JobName.toString().trim()
                var aBy = assignedBy.toString().trim()
                var aTo = assignedTo.toString().trim()
